<div class="container-fluid">
  ...
  <div class="jumbotron">
    ...
    <p><a class="btn btn-lg btn-info" href="<?php echo $site->base;?>/" role="button" target="_parent" >Return to home</a></p>
    <br />

    <span class="lead">Search the site</span>
    <form role="form" class="form-inline" onsubmit="top.location.href='<?php echo $site->base?>/keyword/'+$('#rezgo-404-search').val(); return false;" target="rezgo_content_frame">
