...
<div class="container-fluid">
  ...
  <div class="rezgo-content-row">
    ...
    <!--<div id="rezgo-about-content"><?php echo $site->getPageContent('review')?></div>-->
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div id="captcha">
              ...
              <br /><div id="rezgo-captcha-error-container" class="rezgo-captcha-error"<?php echo (isset($captcha_error) ? '' : ' style="display:none"' )?>><?php echo $captcha_error?></div>
            </div>
          </div>
        </div>          
        <?php} ?>
